...
while True:
	...
	if response == 's':
		...
		if cash_out%10 != 0:
			...
			print("DATE AND TIME OF WITHDRAWAL IS :",now)
			print('*************')
			print('-----------------------------------')
		...
		if cash_in%10 != 0:
			print('----------------------------------------------------')
			print('******************')
			print('AMOUNT YOU WANT TO LODGE MUST BE MINIMUM OF 100 RUPEE NOTE')
			print('******************')
			print('----------------------------------------------------')
		else:
			...
			print('**************')
			print('YOUR NEW BALANCE IS: ', amounts[n], 'RUPEES')
			print("DATE AND TIME OF LODGEMENT:",now)
			print('**************')
			print('----------------------------------------')
	elif response == 'p':
		print('-----------------------------')
